...
# with command line options: step3_descope200MCHFnoAging --fileout file:out_reco.root --mc --eventcontent RECOSIM --customise RecoParticleFlow/PandoraTranslator/customizeHGCalPandora_cff.cust_2023HGCalPandoraMuon,Configuration/DataProcessing/Utils.addMonitoring,L1Trigger/L1IntegratedMuonTrigger/phase2DescopingScenarios.descope200MCHFnoAging --datatier GEN-SIM-RECO --conditions PH2_1K_FB_V6::All --step HLT --magField 38T_PostLS1 --filein file:/afs/cern.ch/work/d/dildick/public/GEM/MuonPhaseIIScopeDoc/CMSSW_6_2_0_SLHC26_patch3/src/001B71CC-0F38-E511-BEE2-002618943918.root --geometry Extended2023HGCalMuon,Extended2023HGCalMuonReco --no_exec -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('step3_descope200MCHFnoAging nevts:10'),
...
from L1Trigger.L1IntegratedMuonTrigger.phase2DescopingScenarios import descope200MCHFnoAging 

#call to customisation function descope200MCHFnoAging imported from L1Trigger.L1IntegratedMuonTrigger.phase2DescopingScenarios
process = descope200MCHFnoAging(process)
