...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
                                         ...
                                         fileName = cms.untracked.string('file:/lustre/cms/store/user/calabria/step3_3_FS.root'),
...
process.reconstruction_step = cms.Path(process.offlineBeamSpot*process.muonlocalreco*process.standalonemuontracking)
