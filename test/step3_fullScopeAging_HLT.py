...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('step3_fullScopeAging nevts:10'),
...
from L1Trigger.L1IntegratedMuonTrigger.phase2DescopingScenarios import fullScopeAging 

#call to customisation function fullScopeAging imported from L1Trigger.L1IntegratedMuonTrigger.phase2DescopingScenarios
process = fullScopeAging(process)
